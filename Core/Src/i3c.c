...
void MX_I3C1_Init(void)
{
  ...
  hi3c1.Init.CtrlBusCharacteristic.SCLPPLowDuration = 0x5f;
  hi3c1.Init.CtrlBusCharacteristic.SCLI3CHighDuration = 0x3f;
  hi3c1.Init.CtrlBusCharacteristic.SCLODLowDuration = 0x5f;
...
void HAL_I3C_MspInit(I3C_HandleTypeDef* i3cHandle)
{
  ...
  */
    ...
    */
    ...
    /* I3C1 interrupt Init */
    HAL_NVIC_SetPriority(I3C1_EV_IRQn, 3, 0);
    HAL_NVIC_EnableIRQ(I3C1_EV_IRQn);
    HAL_NVIC_SetPriority(I3C1_ER_IRQn, 3, 0);
